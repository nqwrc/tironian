...
/**
 * Tironian's inert data definition.
 *
...
export const tironianDefinition = defineData({
...
/** The typed view of one store through Tironian's workspace. */
export type TironianData = DataView<typeof tironianDefinition>;
 ...
 */
export type TironianSettingValues = KvOf<typeof tironianDefinition>;
