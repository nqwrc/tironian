...
- **Types owned by one module** live in that module. Example: `DeviceAcquisitionOutcome` lives in the `@tironian/recorder` package, which owns browser microphone device vocabulary.
