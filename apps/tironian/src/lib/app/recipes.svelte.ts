...
import type { Recipe, TironianData } from '../workspace';

/** The shipped recipes are read-only, so editing one writes a copy. */
const BUILTIN_PREFIX = 'builtin:';

export function createTironianRecipes({
	table,
}: {
	table: TironianData['tables']['recipes'];
}) {
...
export type TironianRecipes = ReturnType<typeof createTironianRecipes>;
