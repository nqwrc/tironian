...
import type { AppRule, TironianData } from '../workspace';

export function createTironianAppRules({
	table,
}: {
	table: TironianData['tables']['appRules'];
}) {
...
export type TironianAppRules = ReturnType<typeof createTironianAppRules>;
