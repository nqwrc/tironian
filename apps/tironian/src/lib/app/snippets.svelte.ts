...
import type { Snippet, TironianData } from '../workspace';

export function createTironianSnippets({
	table,
}: {
	table: TironianData['tables']['snippets'];
}) {
...
export type TironianSnippets = ReturnType<typeof createTironianSnippets>;
