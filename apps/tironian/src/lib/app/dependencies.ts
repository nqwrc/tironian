...
import type { TironianAppDependencies } from './app';
 ...
 * `openTironianApp` inside the mounted Svelte root, where the raw `{#await}`
 ...
 */
export const tironianDependencies: TironianAppDependencies = {
	blobs: BlobsLive,
};
