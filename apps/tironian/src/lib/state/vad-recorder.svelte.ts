...
import { DICTATION_BASE_PATHNAME } from '$lib/constants/urls';
 ...
 * the two pieces that are Tironian's, not the capability's:
 *
...
function createReactiveVadRecorder() {
	// The SPA is mounted below Tironian's shared origin, so runtime asset fetches
	// must stay below the Tironian base too.
