...
export function polishStatus(app: TironianApp): PolishStatus {
 ...
 */
export function polishDestination(app: TironianApp): string {
 ...
 */
export function polishWillRun(app: TironianApp, input: string): boolean {
