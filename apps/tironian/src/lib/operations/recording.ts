...
const log = createLogger('tironian/recording');
 ...
 */
function canStartCapture(app: TironianApp): boolean {
	...
	report.info({
		...
		action: {
			...
			onClick: () => goto(dictationPath('/settings/processing')),
		},
	});
	return false;
}
...
const ENDED_NOTICE: Record<RecordingEndedReason, string> = {
	...
	storageFailed:
		"Tironian couldn't keep writing the recording to disk, so it stopped.",
};
 ...
 */
export function watchManualRecordingEnded(app: TironianApp): void {
...
export async function stopManualRecording(app: TironianApp) {
...
export function toggleManualRecording(app: TironianApp) {
...
export async function cancelRecording(app: TironianApp) {
...
function pausePlaybackForSpeech(app: TironianApp) {
...
export async function startVadRecording(app: TironianApp) {
...
export async function stopVadRecording(app: TironianApp) {
...
export function toggleVadRecording(app: TironianApp) {
