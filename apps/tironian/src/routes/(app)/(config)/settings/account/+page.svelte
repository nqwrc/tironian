...
<script lang="ts">
	...
	import { exportRecordingsMarkdown } from '$lib/app/recordings-markdown-export';
	import { exportSettingsBundle } from '$lib/app/settings-bundle-export';
	import {
		applySettingsBundle,
	...
	} from '$lib/app/settings-bundle-types';
	import {
		PREFERENCE_CATEGORIES,
		PREFERENCE_CATEGORY_LABELS,
	} from '$lib/app/settings-categories';
		...
		<Field.Set id="analytics" class="scroll-mt-20">
			...
			<Field.Group>
				...
				<Field.Description>
					...
					<Link
						href="https://github.com/nqwrc/tironian/blob/main/apps/tironian/src/lib/services/analytics/types.ts"
						target="_blank"
					...
					<Link
						href="https://github.com/search?q=repo%3Anqwrc%2Ftironian+logEvent&type=code"
						target="_blank"
						rel="noopener noreferrer"
					>
