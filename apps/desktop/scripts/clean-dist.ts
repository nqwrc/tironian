...
// Every entry, not a per-application allowlist: a deleted app that never got
// its own removal step here would otherwise leave a stale build behind, and
// `tauri build` bundles anything it finds under
