...
This package is part of the Tironian monorepo and is used internally. To use it in your app:

```json
{
  "dependencies": {
    "@tironian/svelte": "workspace:*"
  }
}
```
...
**Note:** For production use, consider wrapping the persisted state in an encapsulated pattern with controlled access methods.
